...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var yn = readData("yn");
        var enjoy = readData("enjoy");
        var a = readData("a");
        var b = readData("b");
        var c = readData("c");
        res.render('result', {results: [color, yn, enjoy, a, b, c]});
        console.log([color, yn, enjoy, a, b, c]);
    });
    ...
    app.get('/survey', function(req, res){
     ...
     app.post('/views/survey', urlencodedParser, function(req, res){
